...
class ManipulatorControl:
    ...
    def go_to_home_pose(self):
        ...
        plan = self.move_group.retime_trajectory(self.move_group.get_current_state(), plan, velocity_scaling_factor = 0.3, acceleration_scaling_factor = 0.3)
        self.move_group.execute(plan, wait = True)
