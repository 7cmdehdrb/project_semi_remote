...
class ManipulatorControl:
    ...
    def go_to_home_pose(self):
        ...
        home_pose.orientation.x = current_orientation[0]
        home_pose.orientation.y = current_orientation[1]
        home_pose.orientation.z = current_orientation[2]
        home_pose.orientation.w = current_orientation[3]
        
        plan, fraction = self.move_group.compute_cartesian_path([home_pose], 0.01, 0.0)
        self.move_group.execute(plan, wait = True)
        self.run_roslaunch_command()
